...
2. **Pre-generated content for Guided Mode.** The 61 guided scenarios ship with static JSON files containing weak/medium/strong prompt options, simulated AI responses, and feedback. Generated once by a local Node.js script (`scripts/generate-content.js`).

3. **Client-side heuristic scorer for Write Your Own.** A regex-based scorer detects which of the 12 communication principles are present in a user's prompt. No API call needed — instant feedback.
...
└── app/                            # Vite + React standalone app
    ...
    └── src/
        ...
        │
        ├── data/
        │   ├── scenarios.js        # 76 scenario definitions (61 guided + 15 freeform)
        ...
        │   └── generated/          # 61 pre-generated JSON files
        │
...
The 61 guided scenario JSON files are generated by `scripts/generate-content.js`, which runs locally on a developer's machine:
